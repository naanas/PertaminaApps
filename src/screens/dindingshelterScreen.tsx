    ...
    <SafeAreaView style={styles.container}>
      ...
      <ScrollView style={styles.content}>
        ...
        <View style={styles.cardContainer}>
          <Text style={styles.cardTitle}>Area Dalam Shelter</Text>
          <Text style={styles.sectionTitle}>CARA MELAKUKAN</Text>
          <Text style={styles.cardDescription}>
          Bersihkan dengan kemoceng & majun
          </Text>
          <Text style={styles.sectionTitle}>STANDARD</Text>
          <Text style={styles.cardDescription}>Tidak ada debu yang menempel</Text>
        </View>

        {/* Next Button */}
        <TouchableOpacity
          style={styles.nextButton}
          onPress={() => navigation.navigate('Pilihan2')}
        >
